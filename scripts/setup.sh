...
echo ""
echo " 下一步:"
echo "   python scripts/generate_oval_data.py      # 生成 OVAL 训练数据"
echo "   bash scripts/run_grpo_smoke.sh              # GRPO 训练"
echo "   bash scripts/oval_grpo_smoke.sh             # OVAL 直接 GRPO"
echo "   MODE=cold bash scripts/run_grpo_smoke.sh    # SFT 冷启动 → GRPO"
echo "=========================================="
