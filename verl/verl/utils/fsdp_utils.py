...
# 抑制 PyTorch FSDP state_dict_type / set_state_dict_type 的 FutureWarning
# 这些 API 在 PyTorch 2.x 中被标记为 deprecated，但 verl 上游尚未迁移到新 API。
# 放在 fsdp_utils.py 中确保所有 Ray worker 子进程也生效。
import warnings
