...
# Suppress transformers false-positive Mistral regex warning on non-Mistral tokenizers
# (e.g., Qwen2TokenizerFast loaded from a local path). vLLM's internal tokenizer init
# does not pass fix_mistral_regex=True, so we silence this globally.
